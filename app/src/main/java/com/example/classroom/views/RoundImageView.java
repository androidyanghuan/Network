...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_right_bottom_corner_radius, 0);
        ...
        mBorderColor = a
                .getColorStateList(R.styleable.RoundImageView_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.RoundImageView_oval, false);
        a.recycle();
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                MyLog.log(TAG, "Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    MyLog.log(TAG, "Failed to create bitmap from drawable!");
                }
            }
            return drawable;
        }
